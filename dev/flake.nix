{
  description = "Development environment for codex-cli-nix";
      ...
      perSystem =
        ...
        in
        {
          treefmt = {
            ...
            # The generated version files are pure data: base64 SRI digests trip
            # the spell checker and carry nothing worth checking.
            settings.global.excludes = [ "versions/*.json" ];
